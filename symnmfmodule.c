...
/**
 * @brief Converts a Python object to a matrix.
...
/**
 * @brief Converts a matrix to a Python object.
...
/**
 * @brief Runs a simple goal (sym, ddg, or norm).
 * @param points_obj A Python object representing the data points.
