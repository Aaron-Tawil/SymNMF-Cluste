...
/* Dispatch the CLI goals and print the requested matrix to stdout. */
...
/* Emit matrix entries to stdout using "%.4f" CSV formatting. */
static int print_matrix(const matrix_t *matrix) {
    size_t row;
    size_t col;
...
/* Compute and print the degree matrix. */
static int output_degree_goal(const matrix_t *points) {
    matrix_t *similarity = NULL;
...
/* Compute and print the normalized similarity matrix. */
static int output_normalized_goal(const matrix_t *points) {
    matrix_t *similarity = NULL;
    matrix_t *degree = NULL;
